    ...
    <div class="content-page">
        ...
        <div class="content">
            ...
            <div class="page-title-group">
                <h4 class="page-title">احتياجات العائلة</h4>
                    ...
                    <div class="row">
                        <div class="cb-col-20 col-sm-6">
                            <div class="widget-panel widget-style-1 bg-warning">
                                ...
                                $stmt = DBClass::$con->prepare("SELECT * FROM family_needs");
                                ...
                                <div class="text-dark text-opt  m-t-5 text-center font-12">عدد احتياجات العائلة</div>
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="dropdown pull-left">
                                        <button class="btn btn-warning btn-md dropdown-toggle" type="button"
                                                data-toggle="dropdown" aria-expanded="false">احتياجات العائلة
                                ...
                                if ($_GET["do"] == "add") {
                                    ...
                                    <div class="card-box">
                                        ...
                                        <div class="card-box-content form-compoenent">
                                            <form id="frm" class="form-horizontal"
                                                ...
                                                <?php
                                                include("Views/Familyneeds_Component.php"); ?>
                                            </form>
                                        </div>
                                    </div>
                                    <?php
                                    ...
                                    if (isset($_GET["searchq"])) {
                                        ...
                                        if (preg_match('/[0-9]/', $textInfo)) {
                                            $stmt = DBClass::$con->prepare("SELECT * FROM family_needs WHERE Area_ID=$textInfo LIMIT 50");
                                        } else {
                                            $stmt = DBClass::$con->prepare("SELECT * FROM family_needs WHERE Area_Name  LIKE '" . $_GET["searchq"] . "%' 
                                            or Area_Office='$textInfo' or Area_Section='$textInfo' LIMIT 50");
                                        }
                                    } else {

                                        $stmt = DBClass::$con->prepare("SELECT * FROM family_needs LIMIT 50 ");
                                    }
                                    ...
                                    <div class="card-box">
                                        <div class="card-box-head  border-b m-t-0">
                                            <h4 class="header-title"><b> بيانات احتياجات العائلة</b></h4>
                                        </div>
                                        <div class="card-box-content form-compoenent">
                                        ...
                                        <form method="post" id="frm-modal" class="modal-content animate"
                                            ...
                                            <div class="container">
                                                ...
                                                <div id="model-component" style="padding-top: 40px;">
                                                    ...
                                                    <?php include('Views/Familyneeds_Component.php'); ?>
